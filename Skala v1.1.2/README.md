...
Clicking it draws a real 10 cm reference line in the viewport and asks you to measure it with a physical ruler. Enter what you measured, and Skala stores a correction — applied globally, across every document, not just the one you calibrated in. No need to know your DPI or Windows scaling percentage yourself. Re-run it any time if you change monitors or the scale drifts.
